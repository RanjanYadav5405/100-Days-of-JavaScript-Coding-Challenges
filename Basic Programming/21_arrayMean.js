...
//todo In math, the mean is the average of a set of numbers,or the numeric value thata Pull up for prec center of a collection of numbers.
...
const calculateMean = (arr) =>{
    ...
    return arr.reduce((accun,curElem) => accun + curElem/arr.length,0)
